...
/// The unperturbed ground state hyperfine transition frequency of the cesium 133 atom in hertz. Represented by the symbol Δ<sub>VCs</sub>.
pub const FREQUENCY_OF_CESIUM: f64 = 9_192_631_770f64;

/// The speed of light in vacuum in meters per second. Represented by the symbol c.
pub const SPEED_OF_LIGHT: f64 = 299_792_458f64;

/// The Planck constant in joule-seconds. Represented by the symbol h.
pub const PLANCK_CONSTANT: f64 = 6.626_070_15e-34f64;

/// The elementary charge in coulomb. Represented by the symbol e.
pub const ELEMENTARY_CHARGE: f64 = 1.602_176_634e-19f64;

/// The Boltzmann constant in joules per kelvin. Represented by the symbol k.
pub const BOLTZMANN_CONSTANT: f64 = 1.380_649e-23f64;

/// The Avogadro constant in reciprocal moles. Represented by the symbol N<sub>A</sub>.
pub const AVOGADRO_CONSTANT: f64 = 6.022_140_76e23f64;

/// The luminous efficacy of monochromatic radiation of frequency 540 × 10<sub>12</sub> hertz in lumens per watt. Represented by the symbol K<sub>cd</sub>.
