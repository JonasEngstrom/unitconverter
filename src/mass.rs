...
pub enum MassUnit {
    /// Defined as one thousandth of a kilogram, which is in turn defined by taking the fixed numerical value of the Planck constant to be 6.62607015 × 10<sup>-34</sup> when expressed in Joule-seconds, which is equal to kilogram-squaremeters per second. The meter and the second being defined from the speed of light in vacuum and the unperturbed ground state hyperfine transition frequency of the cesum 133 atom, since the 2019 revision of the SI system. Represented by the symbol g.<sup>1</sup>
    Gram,
